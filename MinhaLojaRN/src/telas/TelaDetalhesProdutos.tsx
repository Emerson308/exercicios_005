...
export type DetalhesProdutoRotaParametros = {
    produtoId: number
}
...
export default function TelaDetalhesProdutos(){
    ...
    useEffect(() => {
        const carregarDetalhesProdutos = async () => {
            setCarregando(true);
            setMensagemErro('');
            try{
                ...
                setMensagemErro(erro.message || "Não foi possível carregar os detalhes do produto");
            } finally {
                setCarregando(false);
            }

        };
        carregarDetalhesProdutos();
    }, [produtoId])
        ...
        return (
            <View style={estilos.containerCentral}>
                ...
                <TouchableOpacity style={estilos.botaoVoltar}>
                    <Text style={estilos.textoBotao} onPress={() => navegacao.goBack()}>Voltar</Text>
                </TouchableOpacity>
            </View>
        )
    }
    ...
    return (
        <ScrollView style={estilos.container}>
            ...
            <Text style={estilos.preco}>{produto.price}</Text>
